...
luajit $SRC_DIR/config/kong-yml-generator.lua $SRC_DIR/config/kong.yml.etlua $SRC_DIR

luajit $SRC_DIR/config/nginx-template-generator.lua $SRC_DIR/config/nginx.template.sample $SRC_DIR
